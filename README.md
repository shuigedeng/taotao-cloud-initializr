...
`taotao-cloud` (taotao云平台) 基于gradle8.5、jdk21, 支持graalvm25, 采用最新的spring 6.1.2、SpringBoot 3.2.1、SpringCloud 2023.0.0、SpringSecurity 6.2.1、Nacos 2.2、Mybatis-Plus 3.5、Redis 7等框架，开发的一款企业级微服务架构的云服务平台， 具有组件化、高性能、功能丰富的特点。代码简洁，架构清晰，组件可自由搭配，遵循SpringBoot编程思想，高度模块化和可配置化。
