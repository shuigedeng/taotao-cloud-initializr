...
package io.spring.start.site.extension.dependency.taotaocloud.common.yml.bootstrap.local;
 ...
 */
@FunctionalInterface
public interface BootstrapLocalYmlFileCustomizer extends Ordered {

	/**
	 * Customizes the given {@link ComposeFile}.
	 * @param applicationYmlFile the compose file to customize
	 */
	void customize(BootstrapYmlFile bootstrapYmlFile);
