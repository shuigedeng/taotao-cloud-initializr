...
import io.spring.start.site.extension.dependency.taotaocloud.configuration.application.local.ApplicationLocalYmlFileCustomizer;
import io.spring.start.site.extension.dependency.taotaocloud.configuration.application.pre.ApplicationPreYmlFileCustomizer;
import io.spring.start.site.extension.dependency.taotaocloud.configuration.application.pro.ApplicationProYmlFileCustomizer;
import io.spring.start.site.extension.dependency.taotaocloud.configuration.application.sit.ApplicationSitYmlFileCustomizer;
    ...
    public void setApplicationContext(ApplicationContext applicationContext) throws BeansException {
        if (applicationContext instanceof ProjectGenerationContext) {
            ...
            for (String s : Env.nameList()) {
                ApplicationConfigurationYmlFile applicationYmlFile = new ApplicationConfigurationYmlFile();
