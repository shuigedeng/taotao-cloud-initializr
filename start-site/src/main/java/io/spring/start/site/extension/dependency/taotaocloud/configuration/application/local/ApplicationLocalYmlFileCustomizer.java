...
package io.spring.start.site.extension.dependency.taotaocloud.configuration.application.local;
 ...
 */
@FunctionalInterface
public interface ApplicationLocalYmlFileCustomizer extends Ordered {

	/**
	 * Customizes the given {@link ComposeFile}.
	 * @param applicationYmlFile the compose file to customize
	 */
	void customize(ApplicationConfigurationYmlFile applicationYmlFile);
